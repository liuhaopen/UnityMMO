        ...
        static int _m_IsDead_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Unity.Entities.EntityManager _entityMgr = (Unity.Entities.EntityManager)translator.GetObject(L, 2, typeof(Unity.Entities.EntityManager));
                    
                        bool gen_ret = UnityMMO.ECSHelper.IsDead( _entity, _entityMgr );
