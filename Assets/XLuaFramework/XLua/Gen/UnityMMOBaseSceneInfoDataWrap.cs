...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOBaseSceneInfoDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityMMO.BaseSceneInfoData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.Vector3>(L, 2))
				{
					...
					UnityMMO.BaseSceneInfoData gen_ret = new UnityMMO.BaseSceneInfoData(_pos);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityMMO.BaseSceneInfoData constructor!");
        ...
        static int _g_get_pos(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.BaseSceneInfoData gen_to_be_invoked = (UnityMMO.BaseSceneInfoData)translator.FastGetCSObj(L, 1);
