...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOEnemyShootStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityMMO.EnemyShootState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityMMO.EnemyShootState));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityMMO.EnemyShootState constructor!");
        ...
        static int _g_get_Cooldown(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.EnemyShootState gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
