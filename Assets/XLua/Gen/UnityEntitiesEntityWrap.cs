...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEntitiesEntityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Unity.Entities.Entity);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(Unity.Entities.Entity));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Unity.Entities.Entity constructor!");
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<Unity.Entities.Entity>(L, 1) && translator.Assignable<Unity.Entities.Entity>(L, 2))
				{
					Unity.Entities.Entity leftside;translator.Get(L, 1, out leftside);
					Unity.Entities.Entity rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need Unity.Entities.Entity!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    object _compare = translator.GetObject(L, 2, typeof(object));
                    
                        bool gen_ret = gen_to_be_invoked.Equals( _compare );
                ...
                if(gen_param_count == 2&& translator.Assignable<Unity.Entities.Entity>(L, 2)) 
                {
                    Unity.Entities.Entity _entity;translator.Get(L, 2, out _entity);
                        ...
                        bool gen_ret = gen_to_be_invoked.Equals( _entity );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Unity.Entities.Entity.Equals!");
        ...
        static int _g_get_Null(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, Unity.Entities.Entity.Null);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
