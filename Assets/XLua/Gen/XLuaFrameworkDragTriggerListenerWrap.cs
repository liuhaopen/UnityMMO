...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaFrameworkDragTriggerListenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLuaFramework.DragTriggerListener);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XLuaFramework.DragTriggerListener gen_ret = new XLuaFramework.DragTriggerListener();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaFramework.DragTriggerListener constructor!");
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        XLuaFramework.DragTriggerListener gen_ret = XLuaFramework.DragTriggerListener.Get( _go );
                        translator.Push(L, gen_ret);
        ...
        static int _m_OnBeginDrag(RealStatePtr L)
        {
		    try {
                ...
                XLuaFramework.DragTriggerListener gen_to_be_invoked = (XLuaFramework.DragTriggerListener)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_onDragBegin(RealStatePtr L)
        {
		    try {
                ...
                XLuaFramework.DragTriggerListener gen_to_be_invoked = (XLuaFramework.DragTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onDragBegin = (XLua.LuaFunction)translator.GetObject(L, 2, typeof(XLua.LuaFunction));
        ...
        static int _s_set_onDragEnd(RealStatePtr L)
        {
		    try {
                ...
                XLuaFramework.DragTriggerListener gen_to_be_invoked = (XLuaFramework.DragTriggerListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onDragEnd = (XLua.LuaFunction)translator.GetObject(L, 2, typeof(XLua.LuaFunction));
