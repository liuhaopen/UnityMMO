...
public class LuaFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("WriteBytesAddLen", WriteBytesAddLen);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteBytesAddLen(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	static int SwapUInt16(IntPtr L)
	{
		try
		{
			...
			ushort o = LuaFramework.ByteBuffer.SwapUInt16(arg0);
			LuaDLL.lua_pushnumber(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int ToLuaString(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.ByteBuffer obj = (LuaFramework.ByteBuffer)ToLua.CheckObject<LuaFramework.ByteBuffer>(L, 1);
			LuaInterface.LuaByteBuffer o = obj.ToLuaString();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
