...
function SkillActions:Init(  )
	...
	self.actions[110010] = function( cfg )
		return Sequence {
			PickTarget {}, 
			Hurt {}, 
			If { Random{cfg.buff.probability}, Buff{400000, cfg.buff} } 
		}
	end
		...
		return Sequence { 
			...
			Repeat {5, 
				Sequence { 
					PickTarget {}, 
					Hurt {}, 
					If { Random{cfg.buff.probability}, Buff{400002, cfg.buff} },
					Delay {700} 
				}
			}
		}
		...
		return Sequence { 
			...
			Repeat {5, 
				Sequence { 
					PickTarget {}, 
					Hurt {}, 
					If { Random{cfg.buff.probability}, Buff{400001, cfg.buff} },
					Delay {700} 
				}
			}
		}
