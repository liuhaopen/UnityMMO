...
ECS.TypeManager.RegisterType("umo.type_id", {value="integer"})
ECS.TypeManager.RegisterType("umo.hp", {cur="integer", max="integer"})

-- UMO.BornPosition = {x=0, y=0, z=0}
-- UMO.MoveSpeed = {speed=0}
-- --巡逻半径
-- UMO.PatrolRadius = {radius=0}
-- UMO.Direction = {x=0, y=0, z=0}
