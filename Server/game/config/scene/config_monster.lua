...
local config = {
	[2000] = {
		type_id = 2000, name = "小灰狼", max_hp=10000, 
	...
	[2001] = {
		type_id = 2001, name = "大灰", max_hp=10000, 
	...
	[2002] = {
		type_id = 2002, name = "金钱猫",max_hp=10000, 
		attr_list = {[1]=100,[2]=100}, move_speed=500, skill_list={}, ai={
	...
	[2003] = {
		type_id = 2003, name = "红袍妖女", max_hp=10000, 
		attr_list = {[1]=100,[2]=100}, move_speed=500, skill_list={}, ai={
			fight_back = true, reborn_time = 1000, remove_after_dead = 500, patrol={type=1, idle_min=2000, idle_max=5000, auto_attack_radius=0}, attack_area = {min_distance=0, max_distance=100}, skill_list = {
	...
	[2004] = {
		type_id = 2004, name = "断头鬼", max_hp=10000, 
		attr_list = {[1]=100,[2]=100}, move_speed=500, skill_list={}, ai={
			fight_back = true, reborn_time = 1000, remove_after_dead = 500, patrol={type=1, idle_min=2000, idle_max=5000, auto_attack_radius=0}, attack_area = {min_distance=0, max_distance=100}, skill_list = {
	...
	[2005] = {
		type_id = 2005, name = "唱大戏的", max_hp=10000, 
		attr_list = {[1]=100,[2]=100}, move_speed=500, skill_list={}, ai={
			fight_back = true, reborn_time = 1000, remove_after_dead = 500, patrol={type=1, idle_min=2000, idle_max=5000, auto_attack_radius=0}, attack_area = {min_distance=0, max_distance=100}, skill_list = {
