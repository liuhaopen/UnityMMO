...
local config = {
	...
	[2002] = {
		...
		attr_list = {[1]=100,[2]=100}, move_speed=500, skill_list={}, ai={
			fight_back = true, reborn_time = 3000, remove_after_dead = 500, patrol={type=1, idle_min=2000, idle_max=5000, auto_attack_radius=0}, attack_area = {min_distance=0, max_distance=100}, skill_list = {
